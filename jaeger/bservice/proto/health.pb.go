...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=bservice.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x62, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2e,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x62, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: bservice.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: bservice.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: bservice.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: bservice.HealthCheckResponse.status:type_name -> bservice.HealthCheckResponse.ServingStatus
	1, // 1: bservice.Health.Check:input_type -> bservice.HealthCheckRequest
	1, // 2: bservice.Health.Watch:input_type -> bservice.HealthCheckRequest
	2, // 3: bservice.Health.Check:output_type -> bservice.HealthCheckResponse
	2, // 4: bservice.Health.Watch:output_type -> bservice.HealthCheckResponse
